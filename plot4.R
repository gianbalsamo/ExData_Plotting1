...
##set up plot window for 2 x 2 plots
par(mfcol=c(2,2))

## insert 4 plots, one by one, into plot window
## this is for plot 1
...
## this is for plot 3
plot(date_time,q$Voltage,type="l",xlab="datetime", ylab="Voltage")

## this is for plot 4
plot(date_time,q$Global_reactive_power,type="l",xlab='datetime',ylab="Global_reactive_power")
